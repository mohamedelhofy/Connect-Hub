...
class RemoveButtonEditor extends DefaultCellEditor {
    ...
    public RemoveButtonEditor(JCheckBox checkBox, String userId, ArrayList<User> pendingList, DefaultTableModel tableModel) {
        super(checkBox);
        this.userId = userId;
        ...
        button.addActionListener((ActionEvent e) -> {
            ...
            if (table != null) {
                ...
                if (selectedRow != -1) {
                    ...
                    fm.removeFriend(userId, friend.getUserId());
    ...
    public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int row, int column) {
        str = (value == null) ? "Remove" : value.toString();
        button.setText(str);
        return button;
    }
