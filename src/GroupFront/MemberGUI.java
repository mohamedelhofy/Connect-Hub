...
public class MemberGUI {
    public static void memberFrame(User user, Group group) {
        JFrame frame = new JFrame("Member Page");
        ...
        JLabel greetingLabel = new JLabel("Hello member, " + user.getUsername(), JLabel.CENTER);
